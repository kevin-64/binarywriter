...
namespace KDB::Primitives
{
	...
	*/
	class Pointer : public Contracts::IDBRecord
	{
	private:
		Pointer();
		PointerFormat m_format;
		unsigned long long m_address;
		unsigned long long m_blockId;
		unsigned long long m_offset;
		int m_size;

	public:
		Pointer(PointerFormat fmt, unsigned long long address, unsigned long long blockId, unsigned long long offset);
