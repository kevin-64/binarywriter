...
namespace KDB::Binary {
	...
	public:
		...
		//temporary; final version will read all types and query the list
		...
		//temporary; in the final version the caller will not need to know the block, so this will not be exposed
